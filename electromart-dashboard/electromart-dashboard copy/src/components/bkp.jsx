...
const Dashboard = () => {
  ...
  // Reset to previous year's allocation
    ...
    <div className="bg-gray-50 min-h-screen p-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">ElectroMart Marketing Budget Optimization Dashboard</h1>
            ...
            <div className="min-w-40">
              ...
              <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="EntertainmentSmall">Entertainment Small</SelectItem>
                  <SelectItem value="Camera">Camera</SelectItem>
                  <SelectItem value="CameraAccessory">Camera Accessory</SelectItem>
                  <SelectItem value="GamingHardware">Gaming Hardware</SelectItem>
                  <SelectItem value="GameCDDVD">Game CD/DVD</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        <div className="mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-blue-600">{currencyFormatter.format(totalBudget)}</div>
                <div className="text-sm text-gray-500 mt-1">
                  {allocationMode === 'optimal' ? 'Optimized allocation based on MMM' : 'Based on previous year allocation'}
                </div>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-green-600">{currencyFormatter.format(expectedRevenue * 1000)}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-purple-600">{((expectedRevenue * 1000 - totalBudget) / totalBudget * 100).toFixed(1)}%</div>
                  ...
                  <CardContent>
                    ...
                    <div className="h-80 flex items-center justify-center">
                      <div className="text-center">
                        <div className="text-5xl font-bold text-blue-600">{currencyFormatter.format(expectedRevenue * 1000)}</div>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader className="bg-blue-50">
                  <CardTitle>Special Day Performance Index (SDPI)</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-sm text-gray-600 mb-4">
                    The SDPI quantifies the impact of special days (holidays, paydays, sale days) on sales performance.
                    A higher SDPI indicates stronger sales uplift during special days in that month.
                  </div>
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart
                      ...
                      >
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="sdpi" name="Special Day Performance Index" fill="#8884d8" />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </CardContent>
